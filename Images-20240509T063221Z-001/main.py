...
def Analysis():
    ...
    try:
        ...
        messagebox.showerror("missing data", "Few data entry missing!")
        return
    ...
    a2.plot(["age", "trestbps", "chol", "thal"], [A, D, E, H])
    ...
    if (prediction[0] == 0):
        ...
        report1.config(text=f"{name}, you do not have a heart disease", font="arial 8")

    else:
        print("The Person has Heart Disease")
        report.config(text=f"Report {1}:", fg="#ed1c24")
        report1.config(text=f"{name}, you have a heart disease", font="arial 8")
...
def Info():
    ...
    icon_window.geometry("700x600+00+100")
    ...
    # Heading
    Label(
        icon_window, text="Information related to dataset", font="robot 15 bold"
    ).pack(padx=20, pady=20)

    # info
    Label(icon_window, text="age - age in years", font="arial 11").place(x=20, y=100)
    Label(icon_window, text="sex - sex (1 = male; 0 = female)", font="arial 11").place(
        x=20, y=130
    )
    Label(
        icon_window,
    ...
    Label(
        icon_window,
        text="trestbps - resting blood pressure (in mm Hg on admission to the hospital)",
        font="arial 11",
    ).place(x=20, y=190)
    Label(icon_window, text="chol - serum cholestoral in mg/dl", font="arial 11").place(
        x=20, y=220
    )
    Label(
        icon_window,
    ...
    Label(
        icon_window,
        text="restcg - resting electrocardiographic results (0 = normal; 1 = having ST-T; 2 = hypertrophy)",
        font="arial 11",
    ).place(x=20, y=280)
    Label(
        icon_window, text="thalach - maximum heart rate achieved", font="arial 11"
    ).place(x=20, y=310)
    Label(
        icon_window,
    ...
    Label(
        icon_window,
        text="thal - 0 = normal; 1 = fixed defect; 2 = reversable defect",
        font="arial 11",
    ).place(x=20, y=460)
...
Label(
    Heading_entry, text="Registration No", font="arial 13", bg="#df2d4b", fg=framefg
).place(x=30, y=0)
Label(Heading_entry, text="Date", font="arial 13", bg="#df2d4b", fg=framefg).place(
    x=430, y=0
)
Label(
    Heading_entry, text="Birth Year", font="arial 13", bg="#df2d4b", fg=framefg
).place(x=430, y=90)
Label(
    Heading_entry, text="Patient Name", font="arial 13", bg="#df2d4b", fg=framefg
).place(x=30, y=90)

Entry_image = PhotoImage(
    file="Images/Rounded Rectangle 1.png"
)
Entry_image2 = PhotoImage(
    file="Images/Rounded Rectangle 2.png"
)
Label(Heading_entry, image=Entry_image, bg="#df24db").place(x=20, y=30)
Label(Heading_entry, image=Entry_image, bg="#df24db").place(x=430, y=30)

Label(Heading_entry, image=Entry_image2, bg="#df24db").place(x=20, y=120)
Label(Heading_entry, image=Entry_image2, bg="#df24db").place(x=430, y=120)
...
###################radio button############################### 5
Label(Detail_entry, text="sex:", font="arial 13", bg=framebg, fg=framefg).place(
    x=10, y=10
)
Label(Detail_entry, text="fbs:", font="arial 13", bg=framebg, fg=framefg).place(
    x=180, y=10
)
Label(Detail_entry, text="exang:", font="arial 13", bg=framebg, fg=framefg).place(
    x=335, y=10
)
...
Label(Detail_entry, text="cp", font="arial 13", bg=framebg, fg=framefg).place(
    x=10, y=50
)
Label(Detail_entry, text="restcg", font="arial 13", bg=framebg, fg=framefg).place(
    x=10, y=90
)
Label(Detail_entry, text="slope", font="arial 13", bg=framebg, fg=framefg).place(
    x=10, y=130
)
Label(Detail_entry, text="ca", font="arial 13", bg=framebg, fg=framefg).place(
    x=10, y=170
)
Label(Detail_entry, text="thal", font="arial 13", bg=framebg, fg=framefg).place(
    x=10, y=210
)
...
def selection4():
    ...
    if input == "0 = typical angina":
        ...
        return 2
    elif input == "3 = asymptomatic angina":
        return 3
    else:
        print(exang)
...
rest_ecg_combobox = Combobox(
    Detail_entry, values=["0", "1", "2"], font="arial 12", state="r", width=11
)
rest_ecg_combobox.place(x=80, y=90)
...
slope_combobox.place(x=80, y=130)

ca_combobox = Combobox(
    Detail_entry, values=["0", "1", "2", "3", "4"], font="arial 12", state="r", width=11
)
ca_combobox.place(x=80, y=170)

thal_combobox = Combobox(
    Detail_entry, values=["0", "1", "2", "3"], font="arial 12", state="r", width=11
)
thal_combobox.place(x=80, y=210)
...
Button(
    root, image=analysis_button, bd=0, bg=background, cursor="hand2", command=Analysis
).place(x=1130, y=240)

#######################################################################################################################
info_button = PhotoImage(file="Images/info.png")
Button(
    root, image=info_button, bd=0, bg=background, cursor="hand2", command=Info
).place(x=10, y=240)


#######################################################################################################################
save_button = PhotoImage(file="Images/save.png")
Button(root, image=save_button, bd=0, bg=background, cursor="hand2", command=Save).place(
    x=1230, y=10
)
...
mode = Button(
    root, image=smoking_icon, bg="#dbe0e3", bd=0, cursor="hand1", command=changemode
)
...
logout_button = Button(
    root, image=logout_icon, bg="#df2d4b", cursor="hand1", bd=0, command=Logout
)
logout_button.place(x=1290, y=10)
